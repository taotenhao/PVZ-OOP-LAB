...
class Wallnut extends Plant {
    ...
    private final int IDLE_FRAMES = 5;
    ...
    public Wallnut(int x, int y) {
        ...
        try {
            idleSheet1 = ImageIO.read(new File("Graphic/wallnut1.png"));
        ...
        try {
            idleSheet2 = ImageIO.read(new File("Graphic/wallnut2.png"));
        ...
        try {
            idleSheet3 = ImageIO.read(new File("Graphic/wallnut3.png"));
    ...
    public void draw(Graphics g) {
        ...
        ShadowRenderer.draw((Graphics2D) g, x + currentDrawW / 2, y + drawH - 8, currentDrawW, 1.0f);
    ...
    public Rectangle getBounds() {
        return new Rectangle(x + 15, y, Math.max(1, stateDrawW[getState()] - 15), drawH);
    }
}
